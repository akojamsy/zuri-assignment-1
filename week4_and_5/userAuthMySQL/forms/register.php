    ...
    <form class="form-control w-50" method="POST" action="../php/action.php">
        ...
        <div class="form-row flex justify-content-center">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="fullnames" placeholder="Full Names" name="fullnames" value="<?= old_value('fullnames') ?>" required>
                <?php if (!empty($_SESSION['error'])) : ?>
                    <span style="background-color:brown ; color:yellow;"></span>
                <?php endif ?>
            </div>
            <div class="form-group">
